...
Instead of messages (please use GitHub Discussions for these, as mentioned in our README.md) that directly ask a question ("My concore build is failing with this error. See attached. Can you help with what went wrong?"), we end up receiving bloated essays with several irrelevant texts and questions.
